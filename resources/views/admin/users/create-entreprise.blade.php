    ...
    <div class="row mb-4 pt-3">
        <div class="col-12">
            <div class="d-flex align-items-center mb-2">
                ...
                <div>
                    <h5 class="mb-0" style="color: #333; font-weight: 600;">Créer une entreprise</h5>
                    <small class="text-muted">Ajouter une nouvelle entreprise au système.</small>
                </div>
            </div>
        </div>
    </div>

    <form method="POST" action="{{ route('admin.users.entreprises.store') }}">
        @csrf
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="effectif" name="effectif"
                        ...
                        <option value="<50" {{ old('effectif') == '<50' ? 'selected' : '' }}>Moins de 50 employés</option>
                        <option value="50-100" {{ old('effectif') == '50-100' ? 'selected' : '' }}>50 à 100 employés</option>
                        <option value="100-500" {{ old('effectif') == '100-500' ? 'selected' : '' }}>100 à 500 employés</option>
                        <option value=">500" {{ old('effectif') == '>500' ? 'selected' : '' }}>Plus de 500 employés</option>
                    </select>
                    @error('effectif')
                        <div class="text-danger small mt-1">{{ $message }}</div>
                    @enderror
        ...
        <div class="d-flex justify-content-end gap-2 mb-4">
            ...
            <button type="submit" class="btn px-4" 
                ...
                <i class="fas fa-plus me-2"></i>Créer l'entreprise
            </button>
        </div>
    </form>
</div>
