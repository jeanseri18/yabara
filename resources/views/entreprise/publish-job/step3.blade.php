                ...
                <div class="card-body p-5">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="border rounded-3 p-4 mb-4" style="background-color: #f8f9fa;">
                                <h5 class="fw-bold mb-3" style="color: #0066FF;">
                                    📄
                                ...
                                <div class="mb-4">
                                    <h3 class="fw-bold mb-2" style="color: #0066FF;">{{ $offre->titre }}</h3>
                        ...
                        <div class="col-lg-4">
                            <div class="card border-0" style="background-color: #f8f9fa;">
                                <div class="card-body">
                                    <h6 class="fw-bold mb-3" style="color: #0066FF;">
                    ...
                    <!-- Boutons d'action -->
                        ...
                        <div>
                            ...
                            @else
                                <a href="{{ route('entreprise.offres.index') }}" class="btn btn-lg px-5" style="background-color: #0066FF; color: white;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-header border-0">
                <h5 class="modal-title fw-bold" style="color: #0066FF;">
                    <i class="bi bi-rocket me-2"></i>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0">
            <div class="modal-body text-center py-5">
                ...
                <h4 class="fw-bold mb-3" style="color: #0066FF;">Offre publiée avec succès !</h4>
                <p class="text-muted mb-4">Votre offre d'emploi est maintenant visible par tous les talents de YABARA.</p>
                <div class="d-grid gap-2">
                    <a href="{{ route('entreprise.offres.index') }}" class="btn btn-lg" style="background-color: #0066FF; color: white;">
                        <i class="bi bi-list me-2"></i>
                        Voir mes offres
                    </a>
