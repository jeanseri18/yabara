...
<head>
    ...
    <style>
        ...
        :root {
            ...
            --yabara-blue: #152747;      /* Bleu foncé */
            --yabara-gold: #f6cd45;      /* Or */
            --yabara-white: #FFFFFF;     /* Blanc */
            --yabara-black: #000000;     /* Noir */
            --yabara-dark-gray: #2F2F2F; /* Textes */
            --yabara-gray: #666666;      /* Gris moyen */
            --yabara-light-gray: #F3F2EF; /* Arrière-plans */
        ...
        .shimmer {
            background: linear-gradient(90deg, transparent, rgba(246, 205, 69, 0.2), transparent);
        ...
        .hover-lift:hover {
            ...
            box-shadow: 0 20px 40px rgba(21, 39, 71, 0.15);
        }
        
        /* Effets de texte */
        .text-gradient {
            background: linear-gradient(135deg, var(--yabara-gold), #f2b826, #f7d463);
        ...
        .yabara-gradient {
            background: linear-gradient(135deg, var(--yabara-blue), #0c192d);
        }
